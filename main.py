...
# Configuration       
cloudinary.config(
    cloud_name="dtb9sttaf",
    api_key="112492585156559",
    api_secret="ZVfO5vOjZlAmRoLq8xaimjIA_mE",
    secure=True
)
...
def process_image():
    ...
    if(action == "remove_bg"):
        img_tag = CloudinaryImage(public_id).image(effect="gen_background_replace:prompt_Minimalist background with a soft pastel gradient even lighting")
